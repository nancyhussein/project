		...
		return apply_filters( 'woodmart_get_info_box_shortcode_params', array(
				...
				*/
				...
				array(
					...
					'style' => array(
						'default' => '#f3f3f3',
						'primary' => woodmart_get_opt( 'primary-color' ) ? woodmart_get_opt( 'primary-color' ) : '#7eb934',
						'alt' => woodmart_get_opt( 'secondary-color' ) ? woodmart_get_opt( 'secondary-color' ) : '#fbbc34',
					),
					'group' => esc_html__( 'Title and Subtitle', 'woodmart' ),
					'edit_field_class' => 'vc_col-sm-6 vc_column',
				),
